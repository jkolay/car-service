...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    final CarRequestErrorModel error =
        new CarRequestErrorModel(
            errors, CarErrorCodeConfig.INVALID_INPUT, ErrorSeverityLevelCodeType.ERROR);
  ...
  public ResponseEntity<Object> handleNotFoundException(CarNotFoundException ex) {
    final CarErrorModel error =
        new CarErrorModel(
            ex.getMessage(), CarErrorCodeConfig.INVALID_INPUT, ErrorSeverityLevelCodeType.ERROR);
  ...
  public ResponseEntity<Object> handleDataIntegrityViolationException(
    ...
    final CarErrorModel error =
        new CarErrorModel(message, CarErrorCodeConfig.DB_ERROR, ErrorSeverityLevelCodeType.ERROR);
  ...
  public final ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException ex) {
    final CarErrorModel error =
        new CarErrorModel(
            ex.getMessage(), CarErrorCodeConfig.DB_ERROR, ErrorSeverityLevelCodeType.ERROR);
    return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
  }
  ...
  public ResponseEntity<Object> handleRuntimeException(RuntimeException ex) {
    final CarErrorModel error =
        new CarErrorModel(
            ex.getMessage(), CarErrorCodeConfig.INTERNAL_ERROR, ErrorSeverityLevelCodeType.ERROR);
  ...
  public ResponseEntity<Object> handleGlobalException(Exception ex) {
    final CarErrorModel error =
        new CarErrorModel(
            ex.getMessage(), CarErrorCodeConfig.GLOBAL_ERROR, ErrorSeverityLevelCodeType.ERROR);
    return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
  }
}
