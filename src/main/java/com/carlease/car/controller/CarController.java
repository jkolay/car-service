...
public class CarController {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public ResponseEntity<CarResponse> updateCar(@Valid @RequestBody CarRequest carRequest,@PathVariable("carId") Integer carId) throws CarNotFoundException, CarException {
        return   ResponseEntity.ok(carService.updateCar(carRequest,carId));

    }

    /**
     * this is the endpoint implementation to retrieve list of cars by providing status as All,Leased or Not-Leased
    ...
    public ResponseEntity<List<CarResponse>> getCars(@PathVariable("status") String status) throws CarException{
    ...
    public void deleteCar(@PathVariable("carId") Integer carId) throws CarNotFoundException, CarException {
